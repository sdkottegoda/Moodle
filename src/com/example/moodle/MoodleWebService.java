...
public class MoodleWebService {
	...
	public void getSiteinfo(String serverurl, SiteInfo siteInfo) {
		...
		JSONObject jsonobj = getWebServiceResponse(serverurl, "moodle_webservice_get_siteinfo", urlParameters, Info.raw.siteinfoxsl);
	...
	public void getUserCourses(String serverurl, int userId, ArrayList<Course> coursesArray) {
		...
		try {
			...
			JSONObject jsonobj = getWebServiceResponse(serverurl, "moodle_enrol_get_users_courses", urlParameters, Info.raw.coursesxsl);
	...
	public void getCourseContents(String serverurl, int courseid, ArrayList<CourseContent> courseContentsArray) {
		...
		try {
			...
			JSONObject jsonobj = getWebServiceResponse(serverurl, "core_course_get_contents", urlParameters, Info.raw.contentxsl);
